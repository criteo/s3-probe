...
func main() {
	...
	latencylatencyBucketName := flag.String("latency-bucket", "monitoring", "Bucket used for the latency monitoring probe (will read and write)")
	durabilityBucketName := flag.String("durability-bucket", "monitoring", "Bucket used for the durability monitoring probe (will read and write)")
